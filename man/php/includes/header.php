...
<from name="register" action="action_register.php" method="GET">
    ...
    <tr>
        <td style="width: 40%;"> real name <span style="color:red;"> </span> </td>
        ...
        <tr>
            <td>Usernam<span style="color:red;"></span></td>
...
<tr>
    <td>repassword <span style="color:red;"> </span></td>
...
<tr>
    <tr>Email <span style="color:red;"></span></tr>
...
<tr>
    ...
    <td> <input type="submit" value="login "/>
            &nbsp; &nbsp; &nbsp;
            <input type="reset" value="sign in "/> </td>
